...
public class FragmentScreen3 extends Fragment{
    ...
    public FragmentScreen3(Context context){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_screen_3, container, false);

        return v;
    }
    private void init(){
        tv_next = (TextView) v.findViewById(R.id.sr3_tv_next);
        ...
        tv_back = (TextView) v.findViewById(R.id.sr3_tv_back);
